                          ...
                          <div class="lg:w-1/2 md:w-2/3 mx-auto">
                            <div class=" -m-2">
                              ...
                              <div class="p-2 flex justify-around mt-4 w-full">
                                <button onclick="location.href='{{route('admin.owners.index')}}' " class="mx-auto text-white bg-gray-400 border-0 py-2 px-8 focus:outline-none hover:bg-gray-500 rounded text-lg">戻る</button>
                                <button class="mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">登録する</button>
                              </div>
                            </div>
                          </div>
                        </div>
