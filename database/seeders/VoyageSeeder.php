    ...
    public function run()
    {
        DB::table('voyages')->insert([
            [
                ...
                'owner_id' => '1',
                'itinerary_number' => '5',
                'operator_name' => 'Ohzawa marine Operator',
                'operator_id' => '1',
            ...
            [
                ...
                'owner_company_name' => '大澤海運',
                'owner_company_id' => '2',
                'cargo_description' => 'パルプ',
                'cargo_amount' => '1600',
                'planned_loading_port' => '新潟港',
                'planned_discharging_port' => '四日市港',
                'planned_loading_date' => '2021/12/15',
                'planned_discharging_date' => '2021/12/19',
                'arrived_port_date' => '2021/12/15 08:10:00',
                'loading_started_date' => '2021/12/15 09:10:00',
                'loading_completed_date' => '2021/12/15 17:10:00',
                'loading_port_disported_date' => '2021/12/19 19:10:00',
                'discharging_port_arrived_date' => '2021/12/19 09:10:00',
                'discharging_start_date' => '2021/12/19 11:10:00',
                'discharging_complete_date' => '2021/12/19 17:10:00',
                'discharging_port_disported_date' => '2021/12/19 19:10:00',
                'complete_flag' => '1',
            ],
            [
                'ship_id' => '4',
            ...
            [
                ...
                'operator_name' => 'Kato Operator',
                'operator_id' => '2',
                'cargo_company_name' => '港区製紙',
                'cargo_company_id' => '3',
                'owner_company_name' => '加藤海運',
                'owner_company_id' => '2',
                'cargo_description' => 'スチール',
                'cargo_amount' => '1900',
                'planned_loading_port' => '東京港',
                'planned_discharging_port' => '四日市港',
                'planned_loading_date' => '2021/12/09',
            ...
            [
                ...
                'owner_id' => '4',
                'itinerary_number' => '2',
                'operator_name' => 'Tanaka Operator',
                'operator_id' => '3',
                'cargo_company_name' => '伊勢製紙',
                'cargo_company_id' => '3',
                'owner_company_name' => '加藤海運',
                'owner_company_id' => '2',
                'cargo_description' => '神パルプ',
                'cargo_amount' => '900',
                'planned_loading_port' => '東京港',
                'planned_discharging_port' => '四日市港',
                'planned_loading_date' => '2021/12/05',
                'planned_discharging_date' => '2021/12/12',
                'arrived_port_date' => '2021/12/05 08:10:00',
                'loading_started_date' => '2021/12/05 09:10:00',
                'loading_completed_date' => '2021/12/05 17:10:00',
                'loading_port_disported_date' => '2021/12/05 19:10:00',
                'discharging_port_arrived_date' => '2021/12/12 09:10:00',
                'discharging_start_date' => '2021/12/12 11:10:00',
                'discharging_complete_date' => '2021/12/12 17:10:00',
                'discharging_port_disported_date' => '2021/12/12 19:10:00',
